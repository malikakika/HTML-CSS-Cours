...
function tchou(){
    ...
    // Liste des boutons
    boutons = [boutonForet, boutonEau, boutonRailHorizontal, boutonRailVertical, boutonRailDroiteVersHaut, boutonRailHautVersDroite, boutonRailDroiteVersBas, boutonRailBasVersDroite];
